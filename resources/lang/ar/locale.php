...
return [
    ...
    "generator_builder" => "انشاء الشاشات",
    "log-viewer" => "عرض سجل الأخطاء",
    "send_notifications" => "ارسال رسالة للتنبيهات",
    "systemReleases" => "إصدارات النظام",
    "systemReleasesFeatures" => "مميزات إصدارات النظام",
    "workOrderTransactionsHistories"=>"سجل تتبع أوامر العمل",
    "SiteSetting"=>"اعدادات الموقع",
    "Analytics" => "Analytics",
    "eCommerce" => "eCommerce",
    "Apps" => "Apps",
