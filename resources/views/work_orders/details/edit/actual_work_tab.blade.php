        ...
        <div class="card-body">
            <div class="row">
                @if ( !$workOrder->project_id  )
                    <div class="form-group col-sm-3">
                        <x-select2 name="project_id" :options="$workOrdersProject" :labelTitle="__('models/workOrders.fields.project_name')"></x-select2>
                        <p class="font-small-2  text-info">{{__('models/workOrders.info_about_choose_project')}}</p>
                    </div>
                @endif
                ...
                <div class="form-group col-sm-4">
                    <x-select2 name="is_assay_form" :options="config('const.assay_forms_status')" :labelTitle="__('المقايسة')"></x-select2>
                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-3">
                            ...
                            <div class="input-group">
                                <input type="number" id="length_dust" name="length_dust" class="touchspinA" onchange="calcTotalActual()"  value="{{$workOrder->landscape->length_dust ?? 0 }}" />
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
                            <label>أسفلت</label>
                            <div class="input-group">
                                <input type="number" id="length_asphalt" name="length_asphalt" class="touchspinA" onchange="calcTotalActual()"  value="{{$workOrder->landscape->length_asphalt ?? 0 }}" />
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
                            <label>رصيف</label>
                            <div class="input-group">
                                <input type="number" id="length_sidewalk" name="length_sidewalk" class="touchspinA" onchange="calcTotalActual()"  value="{{$workOrder->landscape->length_sidewalk ?? 0 }}" />
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
                            <label>إجمالي</label>
                            <div class="input-group">
                                <input type="number" id="length_total" name="length_total" class="touchspinA" onchange="calcTotalActual()"  value="{{$workOrder->landscape->length_total ?? 0 }}" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-3">
                            ...
                            <div class="input-group">
                                <input type="number" id="cabel_length_hv" name="cabel_length_hv" class="touchspinA" onchange="calcTotalActual()"  value="{{$workOrder->landscape->cabel_length_hv ?? 0 }}" />
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
                            <label>طول كيبل ضغط منخفض 70</label>
                            <div class="input-group">
                                <input type="number" id="cabel_length_lv70" name="cabel_length_lv70" class="touchspinA" onchange="calcTotalActual()"  value="{{$workOrder->landscape->cabel_length_lv70 ?? 0 }}" />
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
                            <label>طول كيبل ضغط منخفض 185</label>
                            <div class="input-group">
                                <input type="number" id="cabel_length_lv185" name="cabel_length_lv185" class="touchspinA" onchange="calcTotalActual()"  value="{{$workOrder->landscape->cabel_length_lv185 ?? 0 }}" />
                            </div>
                        </div>
                        <div class="form-group col-sm-3">
                            <label>طول كيبل ضغط منخفض 300</label>
                            <div class="input-group">
                                <input type="number" id="cabel_length_lv300" name="cabel_length_lv300" class="touchspinC" value="{{$workOrder->landscape->cabel_length_lv300 ?? 0 }}" />
                            </div>
                        </div>
                    </div>
                </fieldset>
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::textarea('note',  $workOrder->landscape->note ?? null, ['class' => 'form-control', 'rows'=>'2']) !!}
                </div>
            </div>
        </div>
    </div>
