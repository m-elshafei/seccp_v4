{{-- <div class="row m-1">
    @if(isset($workOrder->x_axis) && isset($workOrder->y_axis))
    <img src="http://maps.google.com/maps/api/staticmap?
center={{$workOrder->x_axis}},{{$workOrder->y_axis}}&markers=color:red%7Clabel:C%7C{{$workOrder->x_axis}},{{$workOrder->y_axis}}&zoom=13&size=640x480&scale=2&key=AIzaSyBy0IjPQRaFVvb6QljJSEVKNM_8i2zapzo">
    @else
        غير محدد
    @endif
</div> --}}
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-sm-6">
                  ...
                  {!! Form::text('x_axis', $workOrder->x_axis, ['class' => 'form-control', 'readonly'=> 'readonly']) !!}
              </div>

              <!-- Y Axis Field -->
              <div class="form-group col-sm-6">
                  {!! Form::label('y_axis', __('models/workOrders.fields.y_axis')) !!}
                  {!! Form::text('y_axis', $workOrder->y_axis, ['class' => 'form-control', 'readonly'=> 'readonly']) !!}
              </div>
            </div>
