...
<div class="col-lg-6 col-12">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-sm-10 col-12 d-flex justify-content-center">
            @if ($percentage)
               <div id="workorder-review-chart">{{$percentage}}</div> 
            @endif
        ...
        <div class="d-flex justify-content-between mt-1">
            ...
            <div class="text-center">
                <p class="card-text mb-50">{{$WorkOrder->status_title['title']}}</p>
                <span class="font-large-1 fw-bold">{{$WorkOrder->count}}</span>
            </div>
            @endforeach
          ...
          <div class="text-center">
            ...
            <span class="font-large-1 fw-bold">{{$emergencyWorkOrderCount}}</span>
          </div>
        </div>
      </div>
    </div>
  ...
  @push('page-script')
    ...
    $(window).on('load', function () {
      ...
      var $white = '#fff';
      var $supportTrackerChart = document.querySelector('#workorder-review-chart');
      var supportTrackerChartValue =parseInt($('#workorder-review-chart').text()); 
      $('#workorder-review-chart').text('');
      var wChartOptions;
