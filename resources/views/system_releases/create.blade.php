...
@section('content')
    ...
    <div>
        ...
        <div class="card">
            ...
            {!! Form::open(['route' => 'systemReleases.store']) !!}
            <div class="card-header">
                
                <h4 class="card-title">
                                @lang('models/systemReleases.singular') - @lang('crud.add_new')
                 
                </h4>
                
                @include('layouts.partials.form_toolbar', ['screen_name' => 'systemReleases','action_name' => 'create'])
            </div>
