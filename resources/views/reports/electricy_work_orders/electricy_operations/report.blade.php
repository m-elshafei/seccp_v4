...
<table width="100%" border="1" cellspacing="0" cellpadding="0" dir="rtl" style="border-collapse:collapse;">
    <tr>
        ...
        <td width="5%" class="title">عدد الطبالي</td>
        <td width="5%" class="title">عدد اللحامات</td>
        <td width="5%" class="title">عدد النهايات</td>
        ...
        <tr>
            ...
            <td class="TextCenter">{{$workOrder->electrical_operation->tablun}}</td>
            <td class="TextCenter">{{$workOrder->electrical_operation->welding}}</td>
            <td class="TextCenter">{{$workOrder->electrical_operation->end}}</td>
