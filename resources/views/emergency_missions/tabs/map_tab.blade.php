          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-sm-6">
                  ...
                  {!! Form::text('utm_easting', null, ['class' => 'form-control', 'readonly'=> 'readonly']) !!}
              </div>
      
              <!-- Y Axis Field -->
              <div class="form-group col-sm-6">
                  {!! Form::label('utm_northing', __('models/workOrders.fields.utm_northing')) !!}
                  {!! Form::text('utm_northing', null, ['class' => 'form-control', 'readonly'=> 'readonly']) !!}
              </div>
            </div>
