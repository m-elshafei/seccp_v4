    ...
    <div>
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h4 class="card-title">{{  __('models/itemsCategories.plural') }} - @lang('crud.edit')  </h4>
                @include('layouts.partials.form_toolbar', ['screen_name' => 'itemsCategories','action_name' => 'edit'])
            </div>
            <div class="card-body">
                <div class="row">
