...
<div class="card border-secondary" id="calculator2">
    <div class="card-header">
        <h4 class="card-title">حاسبة الحفريات شارع رئيسي</h4>
    </div>
    <div class="card-body">
        <table class="table table-hover table-sm">
            <thead>
            <tr>
                <th colspan="5">الحفريات الاسفلتية / ض م / ش رئيسي</th>
                <th>اعادة الاسفلت</th>
            </tr>
            <tr class="table-dark">
                <td>عدد الكيبلات</td>
    ...
    Vue.createApp({
        methods: {
            cale(n) {
                ...
                this.amount_1 = (this.fossil_1 * (this.pres_1 + 0.6)).toFixed(1);
                ...
                this.amount_2 = (this.fossil_2 * (this.pres_2 + 0.6)).toFixed(1);

                this.total_3 = (this.fossil_3 * 0.1 * 0.65).toFixed(1);
                this.amount_3 = (this.fossil_3 * (this.pres_3 + 0.6)).toFixed(1);

                this.total_4 = (this.fossil_4 * 0.2 * 0.65).toFixed(1);
                this.amount_4 = (this.fossil_4 * (this.pres_4 + 0.6)).toFixed(1);

                this.total_5 = (this.fossil_5 * 0.3 * 0.65).toFixed(1);
                this.amount_5 = (this.fossil_5 * (this.pres_5 + 0.6)).toFixed(1);

                this.total_6 = (this.fossil_6 * 0.4 * 0.65).toFixed(1);
                this.amount_6 = (this.fossil_6 * (this.pres_6 + 0.6)).toFixed(1);
            },
        },
        data() {
            return {
