    ...
    <section class="content">
        ...
        <div class="box box-primary col-lg-12">
            <div class="box-header" style="margin-top: 10px">
                <h1 class="box-title" style="font-size: 30px">InfyOm Laravel Generator Builder
                    <a id="btnModelReset" class="btn btn-flat btn-info btn-default" href="{{ url("/home")}}">{{__("Back To Home Page")}}</a>
                </h1>
