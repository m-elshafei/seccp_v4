...
class WorkOrdersReportsController extends ReportController
{
    ...
    public function unfinishedDrillingWorkOrdersReport(Request $request)
    {
    ...
    public function finishedDrillingWorkOrdersReport(Request $request)
    {
    ...
    public function electricTowerWorkOrdersReport(Request $request)
    {
    ...
    public function finishedElectricyWorkOrdersReport(Request $request)
    {
    ...
    public function electricyOperationsReport(Request $request)
    {
    ...
    public function electricyCountersReport(Request $request)
    {
