...
class WorkOrdersPermitController extends AppBaseController
{
    ...
    public function calculateCounterExtension($workOrdersPermitsExtension)
    {
        $counterExtension = 0;
    ...
    public function calculateCounter($items)
    {
        $counter = 0;
    ...
    public function calculateTotalAmount($workOrdersPermit)
    {
    ...
    public function RecalculateTotalAmount($workOrdersPermit)
    {
        $totalExtendAmount = intval($workOrdersPermit->total_extend_amount);
        $totalFinesAmount = intval($workOrdersPermit->total_fines_amount);
    ...
    public function recalculateWorkOrdersPermit()
    {
