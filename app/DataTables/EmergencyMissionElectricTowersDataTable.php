...
class EmergencyMissionElectricTowersDataTable extends AppDataTable
{
    ...
    public function query(EmergencyMissionsV $model)
    {
        ...
        return $model->newQuery()->where("is_emergency_mission",1)->where("created_user_department_id",3)->with(['currentDepartment','district','parent','missionType']);
    }
...
// 'district_id' => new Column(['title' => __('models/workOrders.fields.district_name'), 'data' => 'district.name','width'=>"10%","defaultContent"=> '']),
            ...
            'customer_number' => new Column(['title' => __('models/emergencyMissions.fields.customer_number'), 'data' => 'customer_number','width'=>"10%"]),
