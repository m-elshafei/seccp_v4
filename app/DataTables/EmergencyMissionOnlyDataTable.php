...
class EmergencyMissionOnlyDataTable extends AppDataTable
{
    ...
    public function query(EmergencyMissionsV $model)
    {
        ...
        return $model->newQuery()->where("is_emergency_mission",1)->where("created_user_department_id",5)->with(['currentDepartment','district','parent','missionType']);
    }
