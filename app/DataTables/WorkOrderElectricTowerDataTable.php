...
class WorkOrderElectricTowerDataTable extends AppDataTable
{
    ...
    protected function getColumns()
    {
        ...
        return [
            ...
            'tower10' => new Column([
                'title' => 'عامود ١٠',
                'data' => 'electricity_tower.tower10',
                'render' => 'function() {
                                    if (typeof data === "undefined") {
                                    return "-";
                                    }
            ...
            'tower13' => new Column([
                'title' => 'عامود ١٣',
                'data' => 'electricity_tower.tower13',
                'render' => 'function() {
                                    if (typeof data === "undefined") {
                                    return "-";
                                    }
            ...
            'converter' => new Column([
                'title' => 'محول',
                'data' => 'electricity_tower.converter',
                'render' => 'function() {
                                    if (typeof data === "undefined") {
                                    return "-";
                                    }
            ...
            'grid_high_voltage' => new Column([
                'title' => 'شبكة ض/ع',
                'data' => 'electricity_tower.grid_high_voltage',
                'render' => 'function() {
                                    if (typeof data === "undefined") {
                                    return "-";
                                    }
            ...
            'electrical_operation_status' => new Column([
                'title' => 'شبكة ض/م',
                'data' => 'electricity_tower.grid_low_voltage',
                'render' => 'function() {
                                    if (typeof data === "undefined") {
                                    return "-";
                                    }
